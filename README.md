# Spectro Cloud Technical Writer Assignment
...
| `submission/explanation.md`    | The explanation of the changes and the test method.   |
| `submission/images/`           | Three screenshots from the test cluster I used.              |
